...
#define ADC_DLYR_DLYVLU                         ((uint32_t)0x1FF) /* Delay time configuration mask */
#define ADC_DLYR_DLYSRC                         ((uint32_t)0x200) /* Trigger delay source selection */
...
#define FLASH_STATR_MODE                        ((uint16_t)0x4000) /* Switch to BOOT area after SW reset */
#define FLASH_STATR_LOCK                        ((uint16_t)0x8000) /* Boot lock: Lock write access to MODE */
...
#define FLASH_OBR_WDG_SW                        ((uint16_t)0x0004) /* WDG_SW: IWDG hardware enable  */
#define FLASH_OBR_nRST_STOP                     ((uint16_t)0x0008) /* nRST_STOP */
#define FLASH_OBR_STANDY_RST                    ((uint16_t)0x0010) /* nRST_STDBY: System reset control in standby mode */
#define FLASH_OBR_nRST_STDBY                    ((uint16_t)0x0010) /* nRST_STDBY: System reset control in standby mode */
#define FLASH_OBR_RST_MODE                      ((uint16_t)0x0060) /* RST_MODE: Configuration word reset delay time */
#define FLASH_OBR_STATR_MODE                    ((uint16_t)0x0080) /* Power-on startup mode: 1=BOOT area, 0=User area */
#define FLASH_OBR_FIX_11                        ((uint16_t)0x0300) /* Reserved bits fixed to "0b11" */
...
#define FLASH_MODEKEYR_KEY1                     ((uint32_t)0x45670123) /* User area program/erase unlock key 1 */
#define FLASH_MODEKEYR_KEY2                     ((uint32_t)0xCDEF89AB) /* User area program/erase unlock key 2 */

/******************  Bit definition for FLASH__BOOT_MODEKEYR register  ******************/
#define FLASH_BOOT_MODEKEYR_KEY1                ((uint32_t)0x45670123) /* BOOT area program/erase unlock key 1 */
#define FLASH_BOOT_MODEKEYR_KEY2                ((uint32_t)0xCDEF89AB) /* BOOT area program/erase unlock key 2 */
...
#define AFIO_PCFR1_SPI1_REMAP_NOREMAP           ((uint32_t)0x00000000) /* No remap (NSS/PC1, CK/PC5, MISO/PC7, MOSI/PC6) */
#define AFIO_PCFR1_SPI1_REMAP_REMAP1            ((uint32_t)0x00000001) /* Remap 1 (NSS/PC0, CK/PC5, MISO/PC7, MOSI/PC6) */

#define AFIO_PCFR1_I2C1_REMAP_NOREMAP           ((uint32_t)0x00000000) /* No remap (SCL/PC2, SDA/PC1) */
#define AFIO_PCFR1_I2C1_REMAP_REMAP1            ((uint32_t)0x00000002) /* Remap (SCL/PD1, SDA/PD0) */
#define AFIO_PCFR1_I2C1_REMAP_REMAP2            ((uint32_t)0x00400000) /* Remap (SCL/PC5, SDA/PC6) */
...
#define AFIO_PCFR1_TIM1_REMAP_2                 ((uint32_t)0x00800000) /* Bit 2 */
...
#define AFIO_PCFR1_TIM1_REMAP_PARTIALREMAP      ((uint32_t)0x00000040) /* Partial remap (ETR/PC5, CH1/PC6, CH2/PC7, CH3/PC0, CH4/PD3, BKIN/PC1, CH1N/PC3, CH2N/PC4, CH3N/PD1). */
#define AFIO_PCFR1_TIM1_REMAP_PARTIALREMAP_1    ((uint32_t)0x00000080) /* Partial remap (ETR/PD4, CH1/PD2, CH2/PA1, CH3/PC3, CH4/PC4, BKIN/PC2, CH1N/PD0, CH2N/PA2, CH3N/PD1) */
...
#define AFIO_PCFR1_TIM1_REMAP_CH1LSI            ((uint32_t)0x00800000) /* Timer 1 CH1 remap input to LSI source */
...
#define AFIO_PCFR1_TIM2_REMAP_NOREMAP           ((uint32_t)0x00000000) /* No remap (CH1/ETR/PD4, CH2/PD3, CH3/PC0, CH4/PD7) */
#define AFIO_PCFR1_TIM2_REMAP_PARTIALREMAP1     ((uint32_t)0x00000100) /* Partial remap (CH1/ETR/PC5, CH2/PC2, CH3/PD2, CH4/PC1) */
...
#define AFIO_PCFR1_SWJ_CFG_ENABLE               ((uint32_t)0x00000000) /* SWD enabled */
#define AFIO_PCFR1_SWJ_CFG_DISABLE              ((uint32_t)0x04000000) /* SWD disabled */
...
#define PWR_CTLR_PLS_MODE0                      ((uint16_t)0x0000) /* PVD threshold 2.85V rising / 2.70V falling  */
#define PWR_CTLR_PLS_MODE1                      ((uint16_t)0x0020) /* PVD threshold 3.05V rising / 2.90V falling  */
#define PWR_CTLR_PLS_MODE2                      ((uint16_t)0x0040) /* PVD threshold 3.30V rising / 3.15V falling  */
#define PWR_CTLR_PLS_MODE3                      ((uint16_t)0x0060) /* PVD threshold 3.50V rising / 3.30V falling  */
#define PWR_CTLR_PLS_MODE4                      ((uint16_t)0x0080) /* PVD threshold 3.70V rising / 3.50V falling  */
#define PWR_CTLR_PLS_MODE5                      ((uint16_t)0x00A0) /* PVD threshold 3.90V rising / 3.70V falling  */
#define PWR_CTLR_PLS_MODE6                      ((uint16_t)0x00C0) /* PVD threshold 4.10V rising / 3.90V falling  */
#define PWR_CTLR_PLS_MODE7                      ((uint16_t)0x00E0) /* PVD threshold 4.40V rising / 4.10V falling  */

/*******************  Bit definition for PWR_CSR register  ********************/
#define PWR_CSR_PVDO                            ((uint16_t)0x0004) /* PVD Output */

/*******************  Bit definition for PWR_AWUCSR register  ********************/
#define PWR_AWUCSR_AWUEN                        ((uint16_t)0x0002) /* Auto Wake-Up Enable */

/*******************  Bit definition for PWR_AWUWR register  ********************/
#define PWR_AWUWR                               ((uint16_t)0x003F) /* AWUWR[5:0] bits (Auto Wake-Up window value) */

/*******************  Bit definition for PWR_AWUWR register  ********************/
#define PWR_AWUPSC                              ((uint16_t)0x000F) /* AWUPSC[3:0] bits (Auto Wake-Up prescaler) */
#define PWR_AWUPSC_0                            ((uint16_t)0x0000) /* AWU Prescaler off */
#define PWR_AWUPSC_2                            ((uint16_t)0x0002) /* AWU Prescaler divide by 2 */
#define PWR_AWUPSC_4                            ((uint16_t)0x0003) /* AWU Prescaler divide by 4 */
#define PWR_AWUPSC_8                            ((uint16_t)0x0004) /* AWU Prescaler divide by 8 */
#define PWR_AWUPSC_16                           ((uint16_t)0x0005) /* AWU Prescaler divide by 16 */
#define PWR_AWUPSC_32                           ((uint16_t)0x0006) /* AWU Prescaler divide by 32 */
#define PWR_AWUPSC_64                           ((uint16_t)0x0007) /* AWU Prescaler divide by 64 */
#define PWR_AWUPSC_128                          ((uint16_t)0x0008) /* AWU Prescaler divide by 128 */
#define PWR_AWUPSC_256                          ((uint16_t)0x0009) /* AWU Prescaler divide by 256 */
#define PWR_AWUPSC_512                          ((uint16_t)0x000A) /* AWU Prescaler divide by 512 */
#define PWR_AWUPSC_1024                         ((uint16_t)0x000B) /* AWU Prescaler divide by 1024 */
#define PWR_AWUPSC_2048                         ((uint16_t)0x000C) /* AWU Prescaler divide by 2048 */
#define PWR_AWUPSC_4096                         ((uint16_t)0x000D) /* AWU Prescaler divide by 4096 */
#define PWR_AWUPSC_10240                        ((uint16_t)0x000E) /* AWU Prescaler divide by 10240 */
#define PWR_AWUPSC_61440                        ((uint16_t)0x000F) /* AWU Prescaler divide by 61440 */
...
#define SPI_CTLR1_LSBFIRST                      ((uint16_t)0x0080) /* LSb transmitted first */
...
#define SPI_HSCR_HSRXEN                         ((uint16_t)0x0001) /* High speed RX Enable */
